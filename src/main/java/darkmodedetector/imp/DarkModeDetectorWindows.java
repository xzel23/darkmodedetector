...
public class DarkModeDetectorWindows extends DarkModeDetectorBase {
    private static final System.Logger LOG = System.getLogger(DarkModeDetectorWindows.class.getName());
    ...
    private static class Holder {
        ...
        private static DarkModeDetector createInstance() {
            try {
                ...
                LOG.log(System.Logger.Level.WARNING, "DarkModeDetectorWindows initialization failed", t);
    ...
    public boolean isDarkMode() {
        try (Arena arena = Arena.ofConfined()) {
            ...
            LOG.log(System.Logger.Level.WARNING, "FFM Windows registry query failed: {}", t.toString());
        }
    ...
    private void closeKeyQuiet(MemorySegment hKey) {
        try {
            ...
            LOG.log(System.Logger.Level.WARNING, "Failed to close Windows registry key: {}", hKey);
            // ignore
        }
    }
}
