...
public class DarkModeDetectorLinux extends DarkModeDetectorBase {
    private static final System.Logger LOG = System.getLogger(DarkModeDetectorLinux.class.getName());
    ...
    private static class Holder {
        ...
        private static DarkModeDetector create() {
            try {
                ...
                LOG.log(System.Logger.Level.WARNING, "Failed to initialize DarkModeDetectorLinux", t);
    ...
    public boolean isDarkModeDetectionSupported() {
        ...
        try {
            ...
            LOG.log(System.Logger.Level.WARNING, "Portal color-scheme read failed, detection unsupported.", e);
            return false;
        }
    }
    ...
    public boolean isDarkMode() {
        try {
            ...
            LOG.log(System.Logger.Level.WARNING, "Failed to detect dark mode via portal", e);
            return false;
        }
    }
    ...
    private void watchLoop() {
        ...
        try {
            ...
            if (watcherRunning.get()) {
                LOG.log(System.Logger.Level.WARNING, "gdbus monitor failed", ioe);
            }
        } finally {
            synchronized (lock) {
                monitorProcess = null;
