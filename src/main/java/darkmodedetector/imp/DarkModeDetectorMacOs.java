 ...
 */
public class DarkModeDetectorMacOs extends DarkModeDetectorBase {
    private static final System.Logger LOG = System.getLogger(DarkModeDetectorMacOs.class.getName());
    ...
    private static class Holder {
        ...
        private static DarkModeDetector createInstance() {
            try {
                ...
                LOG.log(System.Logger.Level.WARNING, "DarkModeDetectorImpMacOs initialization failed", e);
    ...
    private void registerForAppearanceChanges() {
        if (observerRegistered.compareAndSet(false, true)) {
            try {
                ...
                LOG.log(System.Logger.Level.WARNING, "Failed to register dark mode notifications", e);
            }
        }
    ...
    private void safeRemoveObserver() {
        try {
            ...
            LOG.log(System.Logger.Level.WARNING, "Ignoring error while removing dark mode observer", t);
        }
    }
    ...
    private void notificationCallback(MemorySegment center, MemorySegment observer, MemorySegment name, MemorySegment object, MemorySegment userInfo) {
        try {
            ...
            LOG.log(System.Logger.Level.WARNING, "Error handling dark mode notification", t);
        }
    }
    ...
    public boolean isDarkMode() {
        try (Arena arena = Arena.ofConfined()) {
            ...
            LOG.log(System.Logger.Level.WARNING, "Failed to detect Dark Mode", e);
            return false;
        }
    }
